...
public class CommandInvoker implements IExecuteCommand {
	...
	/* (non-Javadoc)
	 * @see invoker.IExecuteCommand#executeCommand(java.lang.String, interfaces.IOutputter)
	 */
	@Override
	public void executeCommand(String command, IOutputter outputter) {
		...
		try {
			...
			if(e.getMessage() != null) {
				outputter.printLn("Unexpected exception while execution command: " + e.getMessage());
			}
			else {
				outputter.printLn("Unknown exception caught");
