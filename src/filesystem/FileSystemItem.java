...
public abstract class FileSystemItem {
	 ...
	 * @return Name of item
	 * - file name if isDirectory() == false
	 * - directory name if isDirectory() == true
	 */
	...
	*/
	 ...
	 * @return - true this item is a directory
	 *         - false this item is not a directory
	 */
	abstract public boolean isDirectory();

	/**Returns the number of files contained by this item
	 * @return number of contained files if isDirectory() == true
