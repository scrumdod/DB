...
public class Directory extends FileSystemItem {
	...
	/**Constructor.
	 * @param name Name of the new directory. May not contain any ':', '/', ',', ' ' or '\' in the name.
	 ...
	 * @param subDir Object of the directory to be added.
	 */
	 ...
	 * it is removed from there.
	 * @param file Object of the file to be added.
	 */
	 ...
	 * @param item Directory or file to be removed from this directory.
	...
	/**Returns the number of files in this directory. Does not count number of files
	...
	@Override
	/**Returns the number of subdirectories in this directory. Does not count number of subdirectories
	 * in the subdirectories.
	 */
