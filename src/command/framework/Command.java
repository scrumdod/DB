 ...
 * <br>
 * Responsibilities:
 * <li> declares an interface for executing an operation. This is
 * <blockquote>
 *      - execute()
 * </blockquote>
 * <li> declares an in interface to pass parameters controlling the execution. This is
 * <blockquote>
 *      - checkNumberOfParameters()<br>
 ...
 *      - getParameters()
 * </blockquote>
 * <li> provides functionality to the invoker. This is
 * <blockquote>
 *      - compareCmdName()<br>
 *      - setParameters()<br>
 *      - checkParameters()<br>
 ...
 * </blockquote>
 * <br>
 * Note: checkParameters() is a Template Method and
 * checkNumberOfParameters() and checkParameterValues() are the hooks for deriving classes 
...
public abstract class Command {
	 ...
	 * Use getParameters() to obtain this list from a concrete command.
	 */
	private ArrayList<String> parameters;
	
	/**Drive on which the command operates.
	 * Use getDrive() to obtain the drive from a concrete command.
	 */
	private IDrive drive;

	/**Constructor.
	 * @param cmdName Name on which the command reacts. This name is automatically converted to lower case letters.
	 * @param drive Drive on which the command operates.
	 */
	protected Command(String cmdName, IDrive drive) {
	 ...
	 * @param cmdName name with which the command name shall be compared.
	 * @return
	...
	/**Checks the passed parameters. This consists of three steps which can all be overwritten by concrete commands.<br>
	 ...
	 * 
	 * @param outputter The IOutputter must be used to output any error description.
	 * @return
	 ...
	 * @throws Exception Thrown if this.parameters is not set. 
	 */
	 ...
	 * 
	 * @param number Number of parameters passed by the caller.
	 * @return
	 ...
	 * Assign the parameters in the parameter-list to appropriate attributes in the
	 * concrete commands.
	 */
